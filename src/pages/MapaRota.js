...
import { Text, View, StyleSheet, TouchableOpacity, Alert, Image, ToastAndroid } from "react-native";
...
export default function MapaRota() {
  ...
  return (
    <>
      ...
      <Modal animationType="slide" transparent={true} visible={modalConcluirEntregaVisible}>
          ...
          <View style={styles.modalView}>
            ...
            <View style={styles.containerActionButtons}>
              <View style={styles.botaoAcao}>
                <TouchableOpacity
                  onPress={() => setModalConcluirEntregaVisible(!modalConcluirEntregaVisible)}>
