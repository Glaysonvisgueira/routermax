...
export default function SliderApresentationThree({ navigation }) {
  return (
    <LinearGradient
    ...
    >
      ...
      <TouchableOpacity style={styles.buttonNext} onPress={() => navigation.navigate('SliderTwo')}>
        ...
        <TouchableOpacity style={styles.buttonNext} onPress={() => navigation.navigate('SliderFour')}>
